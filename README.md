...
<div style="max-width:900px;margin:26px auto 10px auto;padding:0 4px;">
  <h2 style="margin-bottom:6px;font-size:24px;font-weight:600;">
    Selected Projects
  </h2>
  <p style="margin-top:0;font-size:15px;color:#555;">
    A curated selection of work I’m especially proud of.
  </p>
</div>

<!-- Project list -->
<div style="max-width:900px;margin:0 auto 8px auto;padding:0 4px;">
  ...
  <div style="display:flex;gap:16px;padding:16px 16px;border-radius:12px;border:1px solid #eeeeee;background:#fafafa;margin-bottom:4px;">
    <div style="flex:0 0 160px;text-align:center;">
      <img
